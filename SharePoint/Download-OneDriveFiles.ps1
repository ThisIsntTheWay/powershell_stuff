...
#Parameters
$OneDriveSiteURL = "https://drmeyer-my.sharepoint.com/personal/martin_rungg_dr-meyer_ch"
...
Try {
    ...
    $SubFolders = $ListItems | Where {
		...
		(($_.FieldValues.FileRef -like "*_raw_archiv_immopro360*") -or `
		($_.FieldValues.FileRef -like "*_raw_archiv_liegenschaften*"))
